...
def intermediate_vqe_states(optimized_circuit: QuantumCircuit, depth_period=1):
    """
    ...
    for instruction in optimized_circuit.decompose().data:
...
def generalized_eigenvalue_solver(hamiltonian, state_vectors, tol=1e-15):
    """
...
def krylov_vqe(hamiltonian, optimized_circuit: QuantumCircuit, depth_period=1):
    """
    ...
    """
    state_vectors = intermediate_vqe_states(optimized_circuit, depth_period)
